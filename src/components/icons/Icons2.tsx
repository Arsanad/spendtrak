...
export const DiamondIcon: React.FC<IconProps> = ({ size = 24, color, strokeWidth = 1.5 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none"><G id="diamond" />
    <Polygon points="12 2 2 9 12 22 22 9 12 2" stroke={color || "url(#diamond)"} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
    <Line x1="2" y1="9" x2="22" y2="9" stroke={color || "url(#diamond)"} strokeWidth={strokeWidth} strokeLinecap="round" />
    <Line x1="12" y1="2" x2="8" y2="9" stroke={color || "url(#diamond)"} strokeWidth={strokeWidth} strokeLinecap="round" />
    <Line x1="12" y1="2" x2="16" y2="9" stroke={color || "url(#diamond)"} strokeWidth={strokeWidth} strokeLinecap="round" />
    <Line x1="8" y1="9" x2="12" y2="22" stroke={color || "url(#diamond)"} strokeWidth={strokeWidth} strokeLinecap="round" />
    <Line x1="16" y1="9" x2="12" y2="22" stroke={color || "url(#diamond)"} strokeWidth={strokeWidth} strokeLinecap="round" />
  </Svg>
);
