  ...
  useEffect(() => {
    if (active) {
      ...
      smoke1Y.value = withRepeat(
        withTiming(-8, { duration: 2000, easing: Easing.out(Easing.ease) }),
        -1,
        false
      );
      ...
      smoke2Y.value = withDelay(
        400,
        withRepeat(
          withTiming(-10, { duration: 2200, easing: Easing.out(Easing.ease) }),
          -1,
          false
        )
      );
      ...
      smoke3Y.value = withDelay(
        800,
        withRepeat(
          withTiming(-7, { duration: 1800, easing: Easing.out(Easing.ease) }),
          -1,
          false
        )
      );
  ...
  useEffect(() => {
    if (active) {
      ...
      steam2Y.value = withDelay(
        ...
        withRepeat(
          withSequence(
            withTiming(-8, { duration: 1800, easing: Easing.out(Easing.ease) }),
            withTiming(0, { duration: 0 })
          ),
          -1,
          false
      ...
      steam3Y.value = withDelay(
        ...
        withRepeat(
          withSequence(
            withTiming(-5, { duration: 1200, easing: Easing.out(Easing.ease) }),
            withTiming(0, { duration: 0 })
          ),
          -1,
          false
  ...
  useEffect(() => {
    if (active) {
      coinY.value = withRepeat(
        withSequence(
          withTiming(0, { duration: 0 }),
          withTiming(12, { duration: 600, easing: Easing.in(Easing.ease) }),
...
export default {
  ...
  Scan: AnimatedScanIcon,
  Plus: AnimatedPlusIcon,
  Bills: AnimatedBillsIcon,
  Stats: AnimatedStatsIcon,
  Food: AnimatedFoodIcon,
  Transport: AnimatedTransportIcon,
  Shopping: AnimatedShoppingIcon,
  Settings: AnimatedSettingsIcon,
  Salary: AnimatedSalaryIcon,
  Budgets: AnimatedBudgetsIcon,
};
